...
var suirveyBlock = document.querySelector('.survey');
    suirveyBlock.addEventListener('mouseenter', function() {
    suirveyBlock.style.backgroundColor = '#ffcccc';
});

suirveyBlock.addEventListener('mouseleave', function() {
    suirveyBlock.style.backgroundColor = '#e3a3d1';
});
